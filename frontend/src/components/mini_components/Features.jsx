...
import { Brain, Home, SquarePen } from "lucide-react";
...
const Skeleton = () => (
    <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl dark:bg-dot-white/[0.2] bg-dot-black/[0.2] [mask-image:radial-gradient(ellipse_at_center,white,transparent)]  border border-white/[0.2] bg-[#111]"></div>
  );
...
const features = [
    {
        ...
        header: <Skeleton />,
        icon: <Brain className="h-8 w-8 text-[#cf0]" />, // Replace with Lucide icon if available
    },
    {
        ...
        header: <Skeleton />,
        icon: <Home className="h-8 w-8 text-[#cf0]" />, // Replace with Lucide icon if available
    },
    {
        ...
        header: <Skeleton />,
        icon: <SquarePen className="h-8 w-8 text-[#cf0]" />, // Replace with Lucide icon if available
    },
];
