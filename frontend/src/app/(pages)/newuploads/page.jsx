                ...
                <div className="flex flex-col gap-4">
                    ...
                    {fileUploaded && (
                        ...
                        <div className="flex justify-between">
                            <Button onClick={()=>handleTask("summarize")} className="px-4 py-2 rounded-md border border-neutral-300 bg-neutral-100 text-neutral-500 text-sm hover:-translate-y-1 transform transition duration-200 hover:shadow-md hover:bg-[#cf0]">
                                Summarize it
                            </Button>
                            <Button onClick={()=>handleTask("notes")} className="px-4 py-2 rounded-md border border-neutral-300 bg-neutral-100 text-neutral-500 text-sm hover:-translate-y-1 transform transition duration-200 hover:shadow-md hover:bg-[#cf0]">
                                Turn it into notes
                            </Button>
                            <Button onClick={()=>handleTask("questions")} className="px-4 py-2 rounded-md border border-neutral-300 bg-neutral-100 text-neutral-500 text-sm hover:-translate-y-1 transform transition duration-200 hover:shadow-md hover:bg-[#cf0]">
